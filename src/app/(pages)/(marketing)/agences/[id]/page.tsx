          ...
          <div className="bg-white rounded-2xl border border-border shadow-sm p-6 lg:sticky lg:top-28">
            ...
            <div className="flex flex-col gap-2">
              <Button className="w-full bg-[#25D366] hover:bg-[#1faa53] text-white" asChild>
                <a
                  href={`https://wa.me/${agency.phone.replace(/[\s+\-()]/g, "")}?text=${encodeURIComponent(`Bonjour ${agency.name}, je vous contacte via Okapi Real Estate.`)}`}
                  target="_blank"
        ...
        <section className="max-w-6xl mx-auto px-6 pb-16">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-sm text-muted-foreground">
              {agencyProperties.length} bien{agencyProperties.length > 1 ? "s" : ""}
            </span>
          </div>
