...
export default async function Page({
  ...
  const raw = await getPropertiesByCategory("rent", "studio");
  ...
  return (
    <PropertyListingPage
      title="Studios à louer à Kinshasa"
      totalListings={all.length}
      mode="rent"
      crumbs={[{ label: "Louer", href: "/louer" }, { label: "Studios" }]}
      categories={[
        { label: "Appartements", count: 0, href: "/louer/appartements" },
        { label: "Studios", count: all.length, href: "/louer/studios" },
