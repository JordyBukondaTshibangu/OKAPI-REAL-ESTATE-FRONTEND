        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div className="bg-card rounded-2xl shadow-md p-8">
            ...
            <form className="space-y-4">
              <div>
                <label className="text-sm font-medium  block mb-1.5">Commune / Quartier</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-sm font-medium  block mb-1.5">Surface (m²)</label>
                  <Input type="number" placeholder="ex: 150" />
                </div>
                <div>
                  <label className="text-sm font-medium  block mb-1.5">Chambres</label>
                  <Input type="number" placeholder="ex: 3" />
                </div>
              </div>
              <div>
                <label className="text-sm font-medium  block mb-1.5">Votre nom</label>
