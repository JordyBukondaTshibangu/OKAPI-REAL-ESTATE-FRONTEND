...
export const metadata = {
  title: "Maisons à vendre à Kinshasa — Okapi Real Estate",
};
...
export default async function Page({
  ...
  return (
    <PropertyListingPage
      title="Maisons à vendre à Kinshasa"
      totalListings={all.length}
      mode="sale"
      crumbs={[{ label: "Vendre", href: "/vendre" }, { label: "Maisons" }]}
      categories={[
        { label: "Maisons", count: all.length, href: "/vendre/maison" },
        { label: "Appartements", count: 0, href: "/vendre/appartement" },
      ]}
      properties={items}
